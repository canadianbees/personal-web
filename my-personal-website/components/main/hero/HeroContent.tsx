    ...
    <motion.div
      ...
      <div className='h-full w-full flex flex-col justify-center items-center md:items-start m-auto text-center md:text-start'>
        <motion.div
          ...
          className="flex flex-col gap-10 font-mono font-bold w-full max-w-full md:gap-5 md:max-w-150 text-4xl md:text-6xl ">
          <MorphingText texts={["celina alzenor", "software engineer", "platypus enjoyer", "solitaire enthusiast"]}/>
          <motion.div
            variants={slideInFromLeft(0.8)}
            className="flex flex-col md:mt-15 text-lg text-gray-400 max-w-full md:max-w-150 gap-10">
              <AuroraText speed={5}>
