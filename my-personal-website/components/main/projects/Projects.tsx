...
const Projects = () => {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-6 px-4 md:px-10 w-full">
        <ProjectCard
          src=""
          videoSrc="/api/portfolio_file?path=project_assets/curve_editor.mp4"
        ...
        <ProjectCard
          src="/api/portfolio_file?path=project_assets/acr/github_logo.png"
        ...
        />
        <ProjectCard
          src="/api/portfolio_file?path=project_assets/anthem/anthem_login.png"
